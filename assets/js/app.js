...
var BasisFixedHeader = function () {
  ...
  _createClass(BasisFixedHeader, [{
    ...
    value: function setHeaderWidth() {
      var scrollbarWidth = (0, _jquery2.default)('body').innerWidth() - this.container[0].clientWidth;
      if (scrollbarWidth > 0) {
...
var _fixedHeader = require('../../node_modules/getbasis-layout/src/js/fixed-header.js');
